      ...
      <div class="col-12 col-md-3 information">
        ...
        <div class="social">
          <a href="#" title="Twitter">
            <img src="../assets/images/contents/contactUs/twitter.svg" alt="Twitter" />
          </a>
          <a href="#" title="Facebook">
            <img src="../assets/images/contents/contactUs/facebook.svg" alt="Facebook" />
          </a>
          <a href="#" title="Linkedin">
            <img src="../assets/images/contents/contactUs/linkedin.svg" alt="Linkedin" />
          </a>
        </div>
      </div>
      <div class="col-12 col-md-5 address">
        ...
        <ul class="items">
          <li class="item d-flex">
            <div>
              <img src="../assets/images/contents/contactUs/location.svg" alt="Location" />
            </div>
          ...
          <li class="item d-flex">
            <div>
              <img src="../assets/images/contents/contactUs/phone.svg" alt="Phone" />
            </div>
